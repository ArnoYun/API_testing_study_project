...
class Logger():
    file_name = f"API_testing_study_project/logs/log_" + str (datetime.datetime.now().strftime("%Y-%m-%d_%H-%M-%S")) + ".log"
    @classmethod
    def write_log_into_file(cls, data: str):
    ...
    def add_request(cls, url: str, method: str):
        ...
        cls.write_log_into_file(data_to_add)
